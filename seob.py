...
def get_stock_info(trdDd):
    ...
    # CSV 파일 저장
    csv_file_path = "C:/Users/kyung/OneDrive/Desktop/stock_info.csv"
    ...
    stock_info_df = pd.read_csv(data)
...
if __name__ == "__main__":
    ...
    stock_info_df = get_stock_info(trdDd)   # 모든 종목 기본 정보

    pbr_1_df = get_pbr_one_companies(trdDd)   # PBR이 1인 기업들

    pbr_less_df = get_pbr_less_one(pbr_1_df)
